"""
AURA v5 — FB SUB-PLATFORM PERSONA PROMPTS (Backward compatibility wrapper)
Delegates prompt generation directly to AuraOne/prompts/ module.
"""

from prompts import build_prompt, enforce_fb_length_limits, FB_PERSONAS
from prompts.shared.global_rules import GLOBAL_RULES
from prompts.platforms.facebook import FB_PERSONAS as SUB_PLATFORM_PROMPTS
