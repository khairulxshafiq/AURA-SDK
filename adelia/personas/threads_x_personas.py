"""
ADELIA — THREADS & X (TWITTER) PERSONA PROMPTS (Backward compatibility wrapper)
Delegates prompt generation directly to adelia/prompts/ module.
"""

from adelia.prompts import build_prompt, THREAD_COUNTS, THREADS_STYLES
from adelia.prompts.platforms.threads import THREADS_GLOBAL
from adelia.prompts.platforms.x import X_GLOBAL
...
def build_x_prompt(count_key: str | int, style_key: str, raw_content: str) -> dict:
