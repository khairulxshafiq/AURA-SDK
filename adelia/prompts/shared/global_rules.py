"""
ADELIA PROMPT ENGINE — Shared Global Rules
Contains shared guidelines applicable across all social media platform prompt builders.
"""

GLOBAL_RULES = """
PERATURAN AM (semua platform):
