"""
ADELIA PROMPT ENGINE — Sakluma Branded Hashtag System & Rotation Logic
...
SAKLUMA_HASHTAGS = {
    ...
    "fb_borak_kawan":     ["#saklumastreet", "#saklumalifestyle"],
    ...
    "borak_kawan":        ["#saklumastreet", "#saklumalifestyle"],
    # Platform lain
