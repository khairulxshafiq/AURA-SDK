"""
ADELIA PROMPT ENGINE — Single Source Registry & Loader

Usage:
    from adelia.prompts import build_prompt, sanitize_hashtags
...
from adelia.prompts.platforms.facebook import build_facebook_prompt, FB_PERSONAS
from adelia.prompts.platforms.threads import build_threads_prompt, THREAD_COUNTS, THREADS_STYLES
from adelia.prompts.platforms.x import build_x_prompt
from adelia.prompts.platforms.lemon8 import build_lemon8_prompt
from adelia.prompts.modifiers.length import enforce_fb_length_limits, get_length_instruction
from adelia.prompts.shared.hashtags import get_hashtags, sanitize_hashtags, SAKLUMA_HASHTAGS, SAKLUMA_POOL
